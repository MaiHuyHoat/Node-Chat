// renderListTitle Conversation
 async function renderListTitleConversation(){
  var divLoading=document.querySelector("#loading-sidebar");
  var divContent=document.querySelector("#content-sidebar");

  var data= await loadTitleConversation();
  // render lại list conversation title
   console.log(data)
    var ulTitle= document.getElementById("listConversation");
    ulTitle.innerHTML=''
    data.forEach(Element=>{

        var contentTitle=`<li class="tyn-aside-item js-toggle-main " onclick="renderConversation('${Element.id}')">
        <div class="tyn-media-group">
          ...
          <div class="tyn-media-col">
            ...
            <div class="tyn-media-row has-dot-sap">
              <p class="content"><strong>${(Element.lastMessage.senderID).trim()==(userSession.id).trim() ? "You" : getLastName(Element.name)} : </strong>${  Element.lastMessage.type!='text'?'has send file' :Element.lastMessage.content}</p>
        ...
        item.innerHTML=contentTitle
        ulTitle.appendChild(item)
    })
   
        divLoading.style.display='none'
        divContent.style.display='block'
}
//render replyIncoming
//render text 
function renderTynReplyIncomingText(massage,sender){
    var tyn_Rebly_Incoming= `<div class="tyn-reply-item incoming">
   ...
   return tyn_Rebly_Incoming;
   }
   function renderTynReplyOutcomingText(message){
     var tyn_Rebly_Outcoming=`<div class="tyn-reply-item outgoing">
     <div class="tyn-reply-group">
       <div class="tyn-reply-bubble">
   ...
   return tyn_Rebly_Outcoming;
   }
// render image
function renderTynReplyIncomingImage(pathImage,sender){
  var tyn_Rebly_Incoming= `<div class="tyn-reply-item incoming">
  <div class="tyn-reply-avatar">
      <div class="tyn-media tyn-size-md tyn-circle">
        <img src="${sender.avatarURL}" alt="">
    ...
    <div class="tyn-reply-bubble">
      <div class="tyn-reply-media">
        <a href="images/gallery/chat/1.jpg" class="glightbox tyn-thumb" data-gallery="media-photo">
          <img src="images/upload/${pathImage}" class="tyn-image" alt="">
        </a>
 ...
 function renderTynReplyOutcomingImage(pathImage){
  var tyn_Rebly_Outcoming=`<div class="tyn-reply-item outgoing">
  <div class="tyn-reply-group">
    <div class="tyn-reply-bubble">
